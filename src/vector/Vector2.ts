...
export const create = (x = 0, y = 0, out: Float32Array = new Float32Array(2)): Float32Array => {
	out[0] = x;
	out[1] = y;
...
export const random = (length = 1, out: Float32Array = new Float32Array(2)): Float32Array => {
