...
export default class Vector4 extends Float32Array implements IVector4 {
	...
	public static set = (x = 0, y = 0, z = 0, w = 0, out: Vector4Like = new Vector4()): Vector4Like => {
		out[0] = x;
		out[1] = y;
		out[2] = z;
		out[4] = w;
