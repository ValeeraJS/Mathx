...
export const inverse = (a: Float32Array, out: Float32Array = new Float32Array(3)): Float32Array => {
	out[0] = 1.0 / a[0];
	out[1] = 1.0 / a[1];
	out[2] = 1.0 / a[2];
...
export const negate = (a: Float32Array, out: Float32Array = new Float32Array(3)): Float32Array => {
	out[0] = -a[0];
	out[1] = -a[1];
	out[2] = -a[2];
