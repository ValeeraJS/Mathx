...
export const fromQuaternion = (q: Float32Array, out: Float32Array): Float32Array => {
	const x = q[0],
		y = q[1],
		z = q[2],
		w = q[3];
...
export const rotateY = (a: Float32Array, rad: number, out: Float32Array): Float32Array => {
	s = Math.sin(rad);
	c = Math.cos(rad);
	a00 = a[0];
	a01 = a[1];
