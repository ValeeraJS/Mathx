...
var ColorRGBA = /** @class */ (function (_super) {
    ...
    ColorRGBA.average = function (color) {
        return (color[0] + color[1] + color[2]) / 3;
    };
    ColorRGBA.averageWeighted = function (color, wr, wg, wb) {
        if (wr === void 0) { wr = 0.299; }
        if (wg === void 0) { wg = 0.587; }
        if (wb === void 0) { wb = 0.114; }
        return color[0] * wr + color[1] * wg + color[2] * wb;
    };
    ColorRGBA.clone = function (color) {
        return new ColorRGBA(color[0], color[1], color[2], color[3]);
    };
    ColorRGBA.create = function (r, g, b, a) {
        if (r === void 0) { r = 0; }
        if (g === void 0) { g = 0; }
        if (b === void 0) { b = 0; }
        if (a === void 0) { a = 1; }
    ...
    ColorRGBA.equals = function (a, b) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (((_a = a.r) !== null && _a !== void 0 ? _a : a[0]) === ((_b = b.r) !== null && _b !== void 0 ? _b : b[0]) &&
            ((_c = a.g) !== null && _c !== void 0 ? _c : a[1]) === ((_d = b.g) !== null && _d !== void 0 ? _d : b[1]) &&
            ((_e = a.b) !== null && _e !== void 0 ? _e : a[2]) === ((_f = b.b) !== null && _f !== void 0 ? _f : b[2]) &&
            ((_g = a.a) !== null && _g !== void 0 ? _g : a[3]) === ((_h = b.a) !== null && _h !== void 0 ? _h : b[3]));
    };
    ColorRGBA.fromArray = function (arr, out) {
        if (out === void 0) { out = new ColorRGBA(); }
        out[0] = arr[0];
        out[1] = arr[1];
        out[2] = arr[2];
        out[3] = arr[3];
    ...
    ColorRGBA.fromHex = function (hex, alpha, out) {
    ...
    ColorRGBA.fromJson = function (json, out) {
        if (out === void 0) { out = new ColorRGBA(); }
        out[0] = json.r;
        out[1] = json.g;
        out[2] = json.b;
    ...
    ColorRGBA.fromScalar = function (scalar, alpha, out) {
        if (alpha === void 0) { alpha = 255; }
        if (out === void 0) { out = new ColorRGBA(); }
        out[0] = scalar;
        out[1] = scalar;
    ...
    ColorRGBA.fromString = function (str, out) {
        if (out === void 0) { out = new ColorRGBA(); }
    ...
    ColorRGBA.grayscale = function (color, wr, wg, wb, out) {
        if (wr === void 0) { wr = 0.299; }
        if (wg === void 0) { wg = 0.587; }
        if (wb === void 0) { wb = 0.114; }
        if (out === void 0) { out = new ColorRGBA(); }
        var gray = ColorRGBA.averageWeighted(color, wr, wg, wb);
...
var ColorRGB = /** @class */ (function (_super) {
    ...
    ColorRGB.average = function (color) {
        return (color[0] + color[1] + color[2]) / 3;
    };
    ColorRGB.averageWeighted = function (color, wr, wg, wb) {
        if (wr === void 0) { wr = 0.299; }
        if (wg === void 0) { wg = 0.587; }
        if (wb === void 0) { wb = 0.114; }
        return color[0] * wr + color[1] * wg + color[2] * wb;
    };
    ColorRGB.clone = function (color) {
        return new ColorRGB(color[0], color[1], color[2]);
    };
    ColorRGB.create = function (r, g, b) {
        if (r === void 0) { r = 0; }
        if (g === void 0) { g = 0; }
        if (b === void 0) { b = 0; }
        return new ColorRGB(r, g, b);
    };
    ColorRGB.equals = function (a, b) {
        var _a, _b, _c, _d, _e, _f;
        return (((_a = a.r) !== null && _a !== void 0 ? _a : a[0]) === ((_b = b.r) !== null && _b !== void 0 ? _b : b[0]) &&
            ((_c = a.g) !== null && _c !== void 0 ? _c : a[1]) === ((_d = b.g) !== null && _d !== void 0 ? _d : b[1]) &&
            ((_e = a.b) !== null && _e !== void 0 ? _e : a[2]) === ((_f = b.b) !== null && _f !== void 0 ? _f : b[2]));
    };
    ColorRGB.fromArray = function (arr, out) {
        if (out === void 0) { out = new ColorRGB(); }
        out[0] = arr[0];
        out[1] = arr[1];
        out[2] = arr[2];
        return out;
    };
    ColorRGB.fromHex = function (hex, out) {
        if (out === void 0) { out = new ColorRGB(); }
        out[0] = hex >> 16;
        out[1] = (hex >> 8) & 255;
        out[2] = hex & 255;
    ...
    ColorRGB.fromJson = function (json, out) {
        if (out === void 0) { out = new ColorRGB(); }
        out[0] = json.r;
        out[1] = json.g;
        out[2] = json.b;
    ...
    ColorRGB.fromScalar = function (scalar, out) {
        if (out === void 0) { out = new ColorRGB(); }
        out[0] = scalar;
        out[1] = scalar;
        out[2] = scalar;
    ...
    ColorRGB.fromString = function (str, out) {
        if (out === void 0) { out = new ColorRGB(); }
        if (str in COLOR_HEX_MAP) {
    ...
    ColorRGB.grayscale = function (color, wr, wg, wb, out) {
        if (wr === void 0) { wr = 0.299; }
        if (wg === void 0) { wg = 0.587; }
        if (wb === void 0) { wb = 0.114; }
        if (out === void 0) { out = new ColorRGB(); }
        var gray = ColorRGB.averageWeighted(color, wr, wg, wb);
...
var ColorGPU = /** @class */ (function (_super) {
    __extends(ColorGPU, _super);
    function ColorGPU(r, g, b, a) {
        if (r === void 0) { r = 0; }
        if (g === void 0) { g = 0; }
        if (b === void 0) { b = 0; }
        if (a === void 0) { a = 0; }
    ...
    ColorGPU.fromColorRGB = function (color, out) {
        if (out === void 0) { out = new ColorGPU(); }
        out[0] = color[0] / 255;
        out[1] = color[1] / 255;
        out[2] = color[2] / 255;
        out[3] = 1;
    ...
    ColorGPU.fromColorRGBA = function (color, out) {
        if (out === void 0) { out = new ColorGPU(); }
        out[0] = color[0] / 255;
        out[1] = color[1] / 255;
        out[2] = color[2] / 255;
    ...
    Object.defineProperty(ColorGPU.prototype, "r", {
        get: function () {
            return this[0];
        },
        set: function (val) {
    ...
    Object.defineProperty(ColorGPU.prototype, "g", {
        get: function () {
            return this[1];
        },
        set: function (val) {
    ...
    Object.defineProperty(ColorGPU.prototype, "b", {
        get: function () {
            return this[2];
        },
        set: function (val) {
    ...
    Object.defineProperty(ColorGPU.prototype, "a", {
        get: function () {
            return this[3];
        },
        set: function (val) {
    ...
    ColorGPU.average = function (color) {
        return (color[0] + color[1] + color[2]) / 3;
    };
    ColorGPU.averageWeighted = function (color, wr, wg, wb) {
        if (wr === void 0) { wr = 0.299; }
        if (wg === void 0) { wg = 0.587; }
        if (wb === void 0) { wb = 0.114; }
        return color[0] * wr + color[1] * wg + color[2] * wb;
    };
    ColorGPU.clone = function (color) {
        return new ColorGPU(color[0], color[1], color[2], color[3]);
    };
    ColorGPU.create = function (r, g, b, a) {
        if (r === void 0) { r = 0; }
        if (g === void 0) { g = 0; }
        if (b === void 0) { b = 0; }
        if (a === void 0) { a = 0; }
    ...
    ColorGPU.fromArray = function (arr, out) {
        if (out === void 0) { out = new ColorGPU(); }
        out[0] = arr[0];
        out[1] = arr[1];
        out[2] = arr[2];
    ...
    ColorGPU.fromHex = function (hex, alpha, out) {
    ...
    ColorGPU.fromJson = function (json, out) {
        if (out === void 0) { out = new ColorGPU(); }
        out[0] = json.r;
        out[1] = json.g;
        out[2] = json.b;
    ...
    ColorGPU.fromScalar = function (scalar, out) {
        if (out === void 0) { out = new ColorGPU(); }
        out[0] = scalar;
        out[1] = scalar;
        out[2] = scalar;
    ...
    ColorGPU.fromString = function (str, out) {
        if (out === void 0) { out = new ColorGPU(); }
        if (str in COLOR_HEX_MAP) {
    ...
    ColorGPU.grayscale = function (color, wr, wg, wb, out) {
        if (wr === void 0) { wr = 0.299; }
        if (wg === void 0) { wg = 0.587; }
        if (wb === void 0) { wb = 0.114; }
        if (out === void 0) { out = new ColorGPU(); }
        var gray = ColorGPU.averageWeighted(color, wr, wg, wb);
 ...
 */
var mapRange = (function (value, range1, range2) {
...
var BackIn = (function (p) {
    var s = 1.70158;
    return p === 1 ? 1 : p * p * ((s + 1) * p - s);
});

var BackInOut = (function (p) {
    var s = 1.70158 * 1.525;
    if ((p *= 2) < 1) {
...
var CircularIn = (function (p) {
    return 1 - Math.sqrt(1 - p * p);
});

var CircularInOut = (function (p) {
    if ((p *= 2) < 1) {
...
var CubicOut = (function (p) {
    return --p * p * p + 1;
});

var ElasticIn = (function (p) {
    if (p === 0 || p === 1) {
        return p;
    }
...
var ExponentialIn = (function (p) {
    return p === 0 ? 0 : Math.pow(1024, p - 1);
});

var ExponentialInOut = (function (p) {
    if (p === 0 || p === 1) {
        return p;
    }
    if ((p *= 2) < 1) {
...
var QuadraticIn = (function (p) {
    return p * p;
});

var QuadraticInOut = (function (p) {
    if ((p *= 2) < 1) {
        return 0.5 * p * p;
    }
    return -0.5 * (--p * (p - 2) - 1);
...
var QuadraticOut = (function (p) {
    return p * (2 - p);
});

var QuarticIn = (function (p) {
    return p * p * p * p;
});

var QuarticInOut = (function (p) {
    if ((p *= 2) < 1) {
        return 0.5 * p * p * p * p;
    }
    p -= 2;
...
var QuarticOut = (function (p) {
    return 1 - --p * p * p * p;
});

var QuinticIn = (function (p) {
    return p * p * p * p * p;
});

var QuinticInOut = (function (p) {
    if ((p *= 2) < 1) {
...
var QuinticOut = (function (p) {
    return --p * p * p * p * p + 1;
});

var SinusoidalIn = (function (p) {
    return 1 - Math.sin(((1.0 - p) * Math.PI) / 2);
});

var SinusoidalInOut = (function (p) {
...
var EulerAngle = /** @class */ (function (_super) {
    __extends(EulerAngle, _super);
    ...
    EulerAngle.clone = function (euler) {
        return new EulerAngle(euler.x, euler.y, euler.z, euler.order);
    };
    EulerAngle.create = function (x, y, z, order) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        if (z === void 0) { z = 0; }
        if (order === void 0) { order = EulerRotationOrders.XYZ; }
    ...
    EulerAngle.fromMatrix4 = function (matrix4, out) {
        if (out === void 0) { out = new EulerAngle(); }
        var m11 = matrix4[0], m12 = matrix4[4], m13 = matrix4[8];
        var m21 = matrix4[1], m22 = matrix4[5], m23 = matrix4[9];
        var m31 = matrix4[2], m32 = matrix4[6], m33 = matrix4[10];
        switch (out.order) {
...
var Matrix3 = /** @class */ (function (_super) {
    ...
    Matrix3.multiplyRotationMatrix = function (a, b, out) {
        if (out === void 0) { out = new Matrix3(); }
        a00$1 = a[0];
        a01$1 = a[1];
        a02$1 = a[2];
    ...
    Matrix3.multiplyScaleMatrix = function (a, b, out) {
        if (out === void 0) { out = new Matrix3(); }
        a00$1 = a[0];
        a01$1 = a[1];
        a02$1 = a[2];
    ...
    Matrix3.multiplyTranslateMatrix = function (a, b, out) {
        if (out === void 0) { out = new Matrix3(); }
        a00$1 = a[0];
        a01$1 = a[1];
        a02$1 = a[2];
...
var Vector3 = /** @class */ (function (_super) {
    ...
    Vector3.angle = function (a, b) {
        ...
        by$2 = b[1];
        bz$2 = b[2];
        var mag1 = Math.sqrt(ax$2 * ax$2 + ay$2 * ay$2 + az$2 * az$2), mag2 = Math.sqrt(bx$2 * bx$2 + by$2 * by$2 + bz$2 * bz$2), mag = mag1 * mag2, cosine = mag && Vector3.dot(a, b) / mag;
...
var x$2 = 0, y$2 = 0, z = 0, det = 0, len$2 = 0, s$2 = 0, t = 0, a = 0, b = 0, c$2 = 0, d = 0, e = 0, f = 0;
...
var Polar = /** @class */ (function () {
     ...
     * @returns {number} this
     */
    Polar.prototype.fromVector2 = function (v) {
        x$1 = v[0];
        y$1 = v[1];
    ...
    Polar.prototype.toString = function () {
        return "(".concat(this.r, ", ").concat(this.a, ")");
    };
    /**
     * @public
     ...
     */
    Polar.prototype.toVector2Json = function (vec2) {
        vec2[0] = this.x();
        vec2[1] = this.y();
        return vec2;
    };
...
var ax$1, ay$1, az$1, aw$1, bx$1, by$1, bz$1, bw;
var s$1 = 0, c$1 = 0, rad = 0, dotTmp = 0, omega = 0, len$1 = 0, scale0 = 0, scale1 = 0;
...
var Quaternion = /** @class */ (function (_super) {
    ...
    Quaternion.angleTo = function (a, b) {
        dotTmp = Quaternion.dot(a, b);
        return Math.acos(2 * dotTmp * dotTmp - 1);
    };
    Quaternion.conjugate = function (a, out) {
    ...
    Quaternion.create = function (x, y, z, w, out) {
        if (x === void 0) { x = 0; }
        if (y === void 0) { y = 0; }
        if (z === void 0) { z = 0; }
        if (w === void 0) { w = 1; }
    ...
    Quaternion.fromAxisAngle = function (axis, rad, out) {
        if (out === void 0) { out = new Quaternion(); }
        rad = rad * 0.5;
        s$1 = Math.sin(rad);
        out[0] = s$1 * axis[0];
    ...
    Quaternion.invert = function (a, out) {
        if (out === void 0) { out = new Quaternion(); }
        ax$1 = a[0];
        ay$1 = a[1];
        az$1 = a[2];
    ...
    Quaternion.lerp = function (a, b, t, out) {
        if (out === void 0) { out = new Quaternion(); }
        ax$1 = a[0];
        ay$1 = a[1];
        az$1 = a[2];
    ...
    Quaternion.multiply = function (a, b, out) {
        if (out === void 0) { out = new Quaternion(); }
        ax$1 = a[0];
        ay$1 = a[1];
        az$1 = a[2];
    ...
    Quaternion.normalize = function (a, out) {
        if (out === void 0) { out = new Quaternion(); }
        ax$1 = a[0];
        ay$1 = a[1];
        az$1 = a[2];
    ...
    Quaternion.rotationTo = function (a, b, out) {
        if (out === void 0) { out = new Quaternion(); }
    ...
    Quaternion.rotateX = function (a, rad, out) {
        if (out === void 0) { out = new Quaternion(); }
        rad *= 0.5;
        ax$1 = a[0];
        ay$1 = a[1];
    ...
    Quaternion.rotateY = function (a, rad, out) {
        if (out === void 0) { out = new Quaternion(); }
        rad *= 0.5;
        ax$1 = a[0];
        ay$1 = a[1];
    ...
    Quaternion.rotateZ = function (a, rad, out) {
        if (out === void 0) { out = new Quaternion(); }
        rad *= 0.5;
        ax$1 = a[0];
        ay$1 = a[1];
    ...
    Quaternion.toAxisAngle = function (q, outAxis) {
    ...
    Quaternion.toString = function (a) {
...
var v1 = new Vector3(), v2 = new Vector3(), v0 = new Vector3(), f1 = new Vector3(), f2 = new Vector3(), f0 = new Vector3();
var ta = new Vector3();
// const ma: Matrix3 = new Matrix3();
var tb = new Vector3(), vA = new Vector3();
var defaultMax = [1, 1, 1];
var Cube = /** @class */ (function () {
    function Cube(a, b) {
        if (a === void 0) { a = new Vector3(); }
        if (b === void 0) { b = Vector3.fromArray(defaultMax); }
        this.min = new Vector3();
        this.max = new Vector3();
        Vector3.min(a, b, this.min);
        Vector3.max(a, b, this.max);
    }
    Cube.clampPoint = function (a, point, out) {
        if (out === void 0) { out = new Vector3(); }
        return Vector3.clamp(point, a.min, a.max, out);
    };
    Cube.containsPoint = function (a, b) {
        return (b[0] >= a.min[0] &&
            b[0] <= a.max[0] &&
            b[1] >= a.min[1] &&
            b[1] <= a.max[1] &&
...
var Sphere = /** @class */ (function () {
    ...
    Sphere.intersectsSphere = function (a, b) {
        r = a.radius + b.radius;
...
var Triangle3 = /** @class */ (function () {
    ...
    Triangle3.area = function (t) {
        var c = Triangle3.getABLength(t);
        var a = Triangle3.getBCLength(t);
        var b = Triangle3.getCALength(t);
        var p = (c + a + b) / 2;
        return Math.sqrt(p * (p - a) * (p - b) * (p - c));
    };
    Triangle3.create = function (a, b, c) {
        if (a === void 0) { a = new Float32Array(defaultA); }
        if (b === void 0) { b = new Float32Array(defaultB); }
        if (c === void 0) { c = new Float32Array(defaultC); }
        return { a: a, b: b, c: c };
    };
    Triangle3.getABLength = function (t) {
        return Vector3.distanceTo(t.a, t.b);
    };
    Triangle3.getBCLength = function (t) {
        return Vector3.distanceTo(t.b, t.c);
    };
    Triangle3.getCALength = function (t) {
        return Vector3.distanceTo(t.c, t.a);
    };
    Triangle3.normal = function (t, out) {
        if (out === void 0) { out = Vector3.create(); }
        Vector3.minus(t.c, t.b, bc);
        Vector3.minus(t.b, t.a, ab);
        Vector3.cross(ab, bc, out);
        return Vector3.normalize(out);
    };
    Triangle3.toFloat32Array = function (t, out) {
...
var Ray3 = /** @class */ (function () {
    ...
    Ray3.at = function (a, b, out) {
        if (out === void 0) { out = new Vector3(); }
        return Vector3.multiplyScalar(a.direction, b, out);
    };
    Ray3.distanceToPoint = function (a, point) {
        return Math.sqrt(Ray3.distanceSqToPoint(a, point));
    };
    Ray3.distanceSqToPoint = function (a, point) {
    ...
    Ray3.lookAt = function (a, b, out) {
        if (out === void 0) { out = new Ray3(); }
        if (a !== out) {
    ...
    Ray3.intersectSphere = function (ray, sphere, target) {
    ...
    Ray3.intersectsSphere = function (ray, sphere) {
...
export { COLOR_HEX_MAP, ColorGPU, ColorRGB, ColorRGBA, constants as Constants, Cube, index as Easing, EulerAngle, EulerRotationOrders, Matrix2, Matrix3, Matrix4, Polar, Quaternion, Ray3, Rectangle2, Sphere, Triangle3, Vector2, Vector3, Vector4, ceilPowerOfTwo, clampCommon as clamp, clampCircle, clampSafeCommon as clampSafe, closeToCommon as closeTo, floorPowerOfTwo, floorToZeroCommon as floorToZero, isPowerOfTwo, lerp, mapRange, randFloat, randInt, rndFloat, rndFloatRange, rndInt, sum, sumArray };
